var app = new Vue({
    ...
    data: {
        ...
        error10:false,
        baseSalary2:1000000,
        overtimePercentage:2.2,
        quantitySlippers:3500,
        percentageSlippers17:0.15,
        percentageSlippers30:0.30,
        quantityShoes:3500,
        percentageShoes10:0.10,
        percentageShoes20:0.20,
        childrenCommission1:80000,
        childrenCommission2:60000,
    },
    methods: {
        getError() {
            if (this.baseSalary2 == "") {
